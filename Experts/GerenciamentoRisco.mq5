...
#property strict
#property description "Boleta de gerenciamento de risco por fases. Tabelas específicas e validadas para os futuros "
#property description "WIN, WDO e CCM; qualquer outro papel da B3 (Ações, ETFs, FIIs) usa uma tabela genérica, com o valor por ponto lido automaticamente do símbolo."
